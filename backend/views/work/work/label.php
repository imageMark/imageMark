    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-8">
            ...
            <div class="box box-solid bg-teal-gradient">
                ...
                <?=$form->field($image,'id')->hiddenInput()->label(false)?>
                <?= $form->field($image, 'image_annotation')->hiddenInput(['maxlength' => true,'id'=>'image_annotation']) ?>
...
<script>
    ...
    {
        //读取图片
        $('#image_to_process').attr("src",'<?=Url::to("@web".$image->image_url)?>');
        //加载图片
